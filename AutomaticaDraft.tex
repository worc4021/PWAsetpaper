...
\author{Rainer M. Schaich}\ead{rainer.schaich@eng.ox.ac.uk},
% \thanksref{Supported by the EPSRC DTA and the Worcester College Martin Senior Scholarship},
\author{Mark Cannon}\ead{mark.cannon@eng.ox.ac.uk}
% \fntext[akn]{Supported by the EPSRC DTA and the Worcester College Martin Senior Scholarship}
% \fntext[coa]{Corresponding author}
...
%
$$\begin{aligned}
\norm{x}_P &= \max_{k\leq n}\left\{\sin\left(\frac{2\pi}{n-1}k\right) x_1 + \cos\left(\frac{2\pi}{n-1}k\right) x_2\right\}\\
 &= \max_{k\leq n}\{F_k x\}.
\end{aligned}$$
%
