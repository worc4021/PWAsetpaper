...
\begin{proof}
  ...
  The proof is completed by noting that, if $\lambda z_1 + (1-\lambda ) z_2 \in\partial S$, then  (\ref{eq:graph:def:p:convexity}) is equivalent to $\mathcal W\bigl(\lambda p_1 + (1-\lambda) p_2 \bigr) \subseteq S$, and by applying the preceding argument for all $\lambda\in (0,1)$ and all $p_1,p_2 \in Y$.
  \qed
% %
