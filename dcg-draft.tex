...
\begin{theorem}\label{thm:p:convexity:graph}
  A set-valued map $\mathcal W$ satisfying $\mathcal W(p)\ni 0$ for all $p\in Y$
...
\begin{proof}
  ...
  %
  Furthermore $\nu\in \mathcal N_{\mathcal W}(p_1)\cap \mathcal N_{\mathcal W}(p_2)$ is also sufficient to ensure (\ref{eq:normal_cone_cond}) and hence also sufficient for $z\in\partial S$.
  %
